...
const menuData = [
    ...
    { category: botellasCategory, name: "Dr Lemon", description: "Botella 1 Litro", price: 8000, img: imgPath + botellasCategory + "/drLemon.jpg" },
    { category: botellasCategory, name: "Cosecha Tardía", description: "Botella 1 Litro con 2 Speed", price: 15000, img: imgPath + botellasCategory + "/cosecha.jpg" },
    { category: botellasCategory, name: "New Age", description: "Botella 1 Litro con 2 Speed", price: 16000, img: imgPath + botellasCategory + "/newAge.jpg" },
    { category: botellasCategory, name: "Novechento", description: "Botella 750 ml con 2 Speed", price: 16000, img: imgPath + botellasCategory + "/novechento.jpg" },
    { category: botellasCategory, name: "Federico Alvear", description: "Botella 750 ml con 2 Speed", price: 20000, img: imgPath + botellasCategory + "/federico.jpg" },
    { category: botellasCategory, name: "Chandón Rose/Aperitif/Delise/Extra Brut", description: "Botella 750 ml con 2 Speed.", price: 36000, img: imgPath + botellasCategory + "/chandon.jpg" },
    { category: botellasCategory, name: "Skyy + Speed/Jugo", description: "Skyy con 2 Speed o un Jugo Baggio", price: 24000, img: imgPath + botellasCategory + "/skyySpeed.jpg" },
    { category: botellasCategory, name: "Skyy + Sprite", description: "Skyy con un Sprite de 1,75 L", price: 26000, img: imgPath + botellasCategory + "/skyySprite.jpg" },
    { category: botellasCategory, name: "Smirnoff + Speed/Jugo", description: "Smirnoff común con 2 Speed o un Jugo Baggio", price: 22000, img: imgPath + botellasCategory + "/smirnoffSpeed.jpg" },
    { category: botellasCategory, name: "Smirnoff + Sprite", description: "Smirnoff común con un Sprite de 1,75 L", price: 23000, img: imgPath + botellasCategory + "/smirnoffSprite.jpg" },
    { category: botellasCategory, name: "Smirnoff Saborizado + Speed/Jugo", description: "Smirnoff saborizado a elección (Manzana Verde, Maracuyá, sandía, cítrico, frambueza) con 2 Speed o un Jugo Baggio", price: 24000, img: imgPath + botellasCategory + "/smirnoffSabJugo.jpg" },
    { category: botellasCategory, name: "Smirnoff Saborizado + Sprite", description: "Smirnoff saborizado a elección (Manzana Verde, Maracuyá, sandía, cítrico, frambueza) con un Sprite de 1,75 L", price: 25000, img: imgPath + botellasCategory + "/smirnoffSabSprite.jpg" },
    ...
    { category: tragosCategory, name: "Caipiroska", description: "Lima machacada, zúcar, Vodka y refresco Lima Limón", price: 8000, img: imgPath + tragosCategory + "/caipiroska.jpg" },
    ...
    { category: tragosCategory, name: "Daiquiri (Frutilla/Durazno/Maracuyá/Ananá/Melón)", description: "Ron, Pulpa de la fruta a elección, Azúcar y Zumo de limón", price: 9000, img: imgPath + tragosCategory + "/daiquiri.jpg" },
    ...
    { category: tragosCategory, name: "Gin Tonic", description: "Copón de Gin con agua tónica y rodajas de limón. Consultar por rodajas de Pomelo", price: 9000, img: imgPath + tragosCategory + "/ginTonic.jpg" },
    ...
    { category: tragosCategory, name: "Margarita Frozzen", description: "Tequila, Triple sec o Blue Curacao, Azúcar, Zumo de Limón", price: 9000, img: imgPath + tragosCategory + "/margarita.jpg" },
    ...
    { category: tragosCategory, name: "Melón con Speed", description: "Medida de Melón en un vaso con hielo + una lata de Speed", price: 9000, img: imgPath + tragosCategory + "/melonSpeed.jpg" },
    { category: tragosCategory, name: "Misil", description: "Tequila, Blue Curacao, Pulpa de Ananá y Pulpa de Frutilla", price: 9000, img: imgPath + tragosCategory + "/misil.jpg" },
    { category: tragosCategory, name: "Mojito", description: "Hojas de menta, azucar, zumo de limón, ron dorado y Gaseosa de Lima limón", price: 9000, img: imgPath + tragosCategory + "/mojito.jpg" },
    ...
    { category: tragosCategory, name: "Shooter Bob Marley (Chupito)", description: "Granadina, pulpa durazno, Licor de Menta", price: 3500, img: imgPath + tragosCategory + "/shotBobMarley.jpg" },
    { category: tragosCategory, name: "Shooter Francesita (Chupito)", description: "Granadina, piña colada, Blue Curacao", price: 3500, img: imgPath + tragosCategory + "/shotFrancesita.jpg" },    
    ...
    { category: sinAlcoholCategory, name: "Speed", description: "Jugo Baggio", price: 4000, img: imgPath + sinAlcoholCategory + "/speed.jpg" },
