...
const menuData = [
    ...
    { category: comidasCategory, name: "Alitas de Pollo", description: "Alitas de Pollos Fritas", price: 7000, img: imgPath + comidasCategory + "/alitasPollo.jpg" },
    ...
    { category: botellasCategory, name: "Cosecha Tardía", description: "Botella 1 Litro con 2 Speed", price: 16000, img: imgPath + botellasCategory + "/cosecha.jpg" },
    { category: botellasCategory, name: "New Age", description: "Botella 1 Litro con 2 Speed", price: 17000, img: imgPath + botellasCategory + "/newAge.jpg" },
    { category: botellasCategory, name: "Novechento", description: "Botella 750 ml con 2 Speed", price: 17000, img: imgPath + botellasCategory + "/novechento.jpg" },
    { category: botellasCategory, name: "Federico Alvear", description: "Botella 750 ml con 2 Speed", price: 22000, img: imgPath + botellasCategory + "/federico.jpg" },
    ...
    { category: tragosCategory, name: "Daiquiri (Frutilla/Durazno/Maracuyá/Ananá/Melón)", description: "Ron, Pulpa de la fruta a elección, Azúcar y Zumo de limón", price: 10000, img: imgPath + tragosCategory + "/daiquiri.jpg" },
